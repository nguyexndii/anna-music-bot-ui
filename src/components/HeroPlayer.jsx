    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
      ...
      {player?.voiceChannel?.name && (
        <div style={{
          ...
          <div>
            <p style={{ margin: 0, fontSize: 12, color: 'var(--ink)', fontWeight: 500 }}>{player.voiceChannel.name}</p>
            <p style={{ margin: '2px 0 0', fontFamily: '"DM Mono", monospace', fontSize: 9, letterSpacing: '0.1em', color: 'var(--muted)' }}>
